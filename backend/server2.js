...
const staticAllowedOrigins = [
  ...
  'https://job-portal-platform-shamseers-projects-613ceea2.vercel.app',
  'https://job-portal-platform-ozarxhr-7785-shamseers-projects-613ceea2.vercel.app',
  // Your frontend URLs (if different)
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    if (origin.endsWith('.vercel.app') || origin.endsWith('.vercel.com')) {
     ...
     if (origin.includes('job-portal-platform-one.vercel.app') || 
         origin.includes('job-portal-platform-shamseers-projects-613ceea2.vercel.app') ||
         origin.includes('job-portal-platform-ozarxhr-7785-shamseers-projects-613ceea2.vercel.app')) {
       return callback(null, true);
     }
